...
% Two images are exported, the original image and the black and white scale
% mask image

imwrite(Image,'processedImages.tif');
imwrite(processedImage, 'processedImages.tif','WriteMode','append');

% All numeric results are exported in a csv file with variable names

diffTable = table(areaInCm, osirixCm, Difference);
writetable(diffTable,'Calc_Results.csv');
